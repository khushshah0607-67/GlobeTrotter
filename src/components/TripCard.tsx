...
export function TripCard({ trip }: { trip: TripCardData }) {
  ...
  return (
    <button
      ...
      className="group w-full overflow-hidden rounded-xl border border-[#d3e4fe] bg-[#ffffff] text-left shadow-sm transition-all duration-200 hover:-translate-y-1 hover:bg-[#eff4ff] hover:shadow-md cursor-pointer"
    >
